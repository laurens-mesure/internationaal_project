...
const listItems = data.map((item, key) => (
    ...
    <div className="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
        ...
        <div
            className="flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-blue-500 text-white relative z-10 title-font font-medium text-sm">{item.no}
        </div>
        <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
            <div
                className="flex-shrink-0 w-20 h-20 dark:bg-gray-800 bg-gray-200 text-blue-400 rounded-full inline-flex items-center justify-center">
